 ...
 */
public class adminDeleteListAdapter extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<ParentRow> parentRowList;
    private ArrayList<ParentRow> originalList;


    public adminDeleteListAdapter(Context context, ArrayList<ParentRow> originalList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Are you sure you want to delete " + childRow.getText());
                builder.setPositiveButton(
                        "Yes",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                RestaurantDatabaseOperations rdo = new RestaurantDatabaseOperations(context);
                                rdo.deleteRestaurant(rdo, childRow.getText());
                                Intent i = new Intent(context, adminDeleteRes.class);
